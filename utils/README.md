...
Some various rough cut scripts I used to build some diagnostics.

Rather than type out the IR codes matched to functions, I built a quick parser to read the header
and map out the Aurora functions to the remote buttons with the right IR codes associated.

This spits out a block of text one can simply include in an function to display a webpage with all codes.
...
```
                  ...
                  "<p><a href=\"ir?code=4294967295\">SMARTMATRIX_HELD -  - Send 0xFFFFFFFF</a></p>" \
                  ...
                  "<p><a href=\"ir?code=2147483647\">ADAFRUIT_HELD -  - Send 0x7FFFFFFF</a></p>" \
                  ...
                  "<p><a href=\"ir?code=4294967295\">SPARKFUN_HELD -  - Send 0xFFFFFFFF</a></p>" \
                  ...
                  "<p><a href=\"ir?code=4294967295\">RONIX_SIX_BUTTON_HELD -  - Send 0xFFFFFFFF</a></p>" \
...
And example Arduino sketch is in `SmartMatrixIRServer.ino`
